import logging
from src.irrigation_decision_system_simplified import IrrigationDecisionSystem
...
def test_irrigation_recommendations():
    ...
    for scenario in test_scenarios:
        ...
        for key, value in recommendation.items():
            if key != 'current_conditions':  # Omitir condiciones actuales para mayor claridad
...
def simulate_feedback():
    ...
    for scenario in test_scenarios:
        ...
        print(f"Recomendación: {scenario['recommendation']['recommendation']}")
        print(f"Resultado: {'Exitoso' if scenario['actual_outcome']['success'] else 'No exitoso'}")
        print(f"Salud del cultivo: {scenario['actual_outcome']['crop_health']}")
        print("\n")
